if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Moon Yield is already running!", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "Moon Yield is waiting for the game to load"
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Moon Yield FE v" .. currentVersion
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/b5fRnbA9us")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/b5fRnbA9us)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Moon Yield support server.'}
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "On mobile, Moon Yield may have issues or features that are not functioning correctly.") end
end)
